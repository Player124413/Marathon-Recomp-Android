...
**Пустой стек + FaultAt=0 — это не «разыменование null-данных».** При
разыменовании данных стек нормально раскручивается и виден кадр виновника.
Пустой стек означает, что **сам PC равен нулю**: поток прыгнул на адрес 0, и
раскручивать нечего — кадра по адресу 0 не существует.
